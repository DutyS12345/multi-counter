...
import styles from "./BasicCounterPage.module.css";
...
export function BasicCounterPage() {
    const [labels, setLabels] = useReducer(updateLabelState, {} as LabelState);
    const [counters, setCounters] = useReducer(updateCounterState, { "counters": 1, "0": 0 });
    var counterCount = counters["counters"];
    var primaryCounters = [];
    for (let i = 0; i < counterCount; i++) {
        primaryCounters.push(
            <BlockCounter
                key={i}
